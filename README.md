...
| File | Purpose |
|------|---------|
| `scripts/process_with_spark.py` | PySpark reads S3, cleans 19.8M trips, joins weather |
| `scripts/quality_checks.py` | 5 automated checks after processing |
| `nyc_dbt/models/staging/stg_trips.sql` | Cleans and enriches raw Snowflake table |
| `nyc_dbt/models/marts/` | Business-ready aggregated tables |
| `dags/nyc_rideshare_dag.py` | Airflow DAG — 6 tasks, @monthly schedule |
